...
Note: I did not used all the data from here. for the Training i used all the data. However for the Test and Validation i've used around 80% of the total data.
